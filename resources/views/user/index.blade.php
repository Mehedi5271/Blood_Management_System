            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class=" vbh">
                        ...
                        <div class="btn btn-success bounceInUp"><a href="{{ route('profile.create') }}">Become A Donor</a>
                        </div>
                        <div class="btn btn-success  bounceInUp"> Request Blood </div>
                        </div>
                </div>
            </div>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    ...
                    <div class=" vbh">
                        ...
                        <div class="btn btn-danger  bounceInUp"> <a href="{{ route('profile.create') }}"> Become A Donor</a>   </div>
