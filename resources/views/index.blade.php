...
<head>
    ...
    <!-- Bootstrap-Core-CSS -->
    <link rel="stylesheet" href="{{asset('index/css/style.css" type="text/css')}}" media="all" />
    <!-- Style-CSS -->
                ...
                <div class="col-lg-7 top-social-agile">
                    <div class="row">
                        ...
                        <div class="col-6 header-top_w3layouts pl-3 text-lg-left text-center">
                            <p class="text-white">
                                <i class="fas fa-map-marker-alt mr-2"></i>Address Placeholder</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-6 top-w3layouts">
                            <p class="text-white">
                                ...
                                <a href="mailto:info@example.com" class="text-white">email@example.com</a>
                            </p>
                        </div>
...
<!-- //header 2 -->
                    ...
                    <div class="col-md-4 w3l-footer my-md-0 my-4">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                ...
                                <p class="ml-4">
                                    <span>Address Placeholder. </p>
                                <div class="clearfix"></div>
                            </li>
                            <li class="my-3">
                                <i class="fas fa-phone float-left"></i>
                                <p class="ml-4">Contact Number Placeholder</p>
                                <div class="clearfix"></div>
                            </li>
                            <li>
                                <i class="far fa-envelope-open float-left"></i>
                                <a href="mailto:info@example.com" class="ml-3">Email Placeholder</a>
                                <div class="clearfix"></div>
                            </li>
                        </ul>
                    </div>
    ...
    <!-- banner slider -->
    <script src="{{asset('index/js/responsiveslides.min.js')}}"></script>
    <script>
        $(function () {
    ...
    <!-- fixed navigation -->
    <script src="{{asset('index/js/fixed-nav.js')}}"></script>
    <!-- //fixed navigation -->

    <!-- smooth scrolling -->
    <script src="{{asset('index/js/SmoothScroll.min.js')}}"></script>
    <!-- move-top -->
    <script src="{{asset('index/js/move-top.js')}}"></script>
    <!-- easing -->
    <script src="{{asset('index/js/easing.js')}}"></script>
    <!--  necessary snippets for few javascript files -->
    <script src="{{asset('index/js/medic.js')}}"></script>
